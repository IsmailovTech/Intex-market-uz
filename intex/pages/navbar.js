        ...
        <>
           ...
           <div className="w-full h-[74px] bg-green-main px-4 md:px-16 sticky top-0 z-50 shadow-2xl " >
                ...
                <ul className="hidden xl:flex" >
                    ...
                    <Link activeClass="active" to="naduv" spy={true} smooth={true} offset={50} duration={700} >
                    ...
                    <Link activeClass="active" to="karkas" spy={true} smooth={true} offset={50} duration={700} >
                    ...
                    <Link activeClass="active" to="aksessuar" spy={true} smooth={true} offset={50} duration={700} >
                ...
                <div className=" xl:hidden" onClick={handleClick}  >
                    ...
                    <div className={ open ? " h-screen w-64 lg:w-96 bg-green-main absolute top-0 left-0 transition-[3s] shadow-2xl shadow-black flex flex-col items-center " : "h-screen w-64 bg-green-main absolute top-0 left-[-256px] transition-[3s] "}>
                        ...
                        <Link activeClass="active" to="main" spy={true} smooth={true} offset={50} duration={700} onClick={closeModal} >
                            <h1 className="text-xl text-white mt-4 font-bold" >INTEX-MARKET.UZ</h1>
                        </Link>
                         
                         <ul className="mt-12 flex flex-col gap-12" >
                         
                         <Link activeClass="active" to="naduv" spy={true} smooth={true} offset={50} duration={700} onClick={closeModal} >
                         ...
                         <Link activeClass="active" to="karkas" spy={true} smooth={true} offset={50} duration={700} onClick={closeModal} >
                         ...
                         <Link activeClass="active" to="aksessuar" spy={true} smooth={true} offset={50} duration={700} onClick={closeModal} >
